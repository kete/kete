...
if Rails.env.test? || Rails.env.development? || Rails.env == "profile"
  Kete::Application.config.secret_token = 'a05fb67d1237cf87cf04a30a7a141d3c1377ae6db1985f15fefa745684790c320e672bda6d9201eea2013f3936bdf57f834006ab4df473c4590cb79944e12a52'
else
  ...
  Kete::Application.config.secret_token = ENV['SECRET_TOKEN']
end
