ActionController::Routing::Routes.draw do |map|
  ...
  map.basket_all_of_category ':urlified_name/all/:controller_name_for_zoom_class/category/:limit_to_choice/', :controller => "search", :action => 'all'
  map.basket_all_private_of_category ':urlified_name/all/:privacy_type/:controller_name_for_zoom_class/category/:limit_to_choice/', :controller => "search", :action => 'all'
