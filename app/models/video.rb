class Video < ActiveRecord::Base
  ...
  has_attachment :storage => :file_system, :file_system_path => "public/video", :content_type => ['application/x-shockwave-flash', 'video/mpeg', 'video/quicktime', 'video/x-msvideo', 'video/quicktime'], :processor => :none
