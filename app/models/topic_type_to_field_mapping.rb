class TopicTypeToFieldMapping < ActiveRecord::Base
  ...
  piggy_back :topic_type_field_label_xml_element_name_xsi_type_multiple_and_description,
      :from => :topic_type_field, :attributes => [:label, :xml_element_name, :xsi_type, :multiple, :description]
