module SlideshowsHelper
  ...
  def link_to_next_in_slideshow(text = t('application.slideshow.next'), current_url = request.url)
  ...
  def link_to_previous_in_slideshow(text = t('application.slideshow.previous'), current_url = request.url)
    current_url = url_without_extras(current_url)
  ...
  def link_to_results(text = t('application.slideshow.all_results'))
    link_to text, slideshow.redirect_to_results_hash
  end

  def link_to_stop_slideshow(text = t('application.slideshow.stop'))
