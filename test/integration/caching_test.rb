...
class CachingTest < ActionController::IntegrationTest
  ...
  context "The homepage cache" do
    ...
    context "when homepage topic is added" do
      ...
      setup do
        @topic = new_topic(@@cache_basket, true, { :title => 'Homepage 1 Title',
    ...
    context "when homepage topic is replaced" do
      ...
      setup do
        @topic1 = new_topic(@@cache_basket, true, { :title => 'Old Homepage Topic Title',
                                                    :description => 'Old Homepage Topic Description' })
        check_cache_current_for(@topic1)
        @topic2 = new_topic(@@cache_basket, true, { :title => 'Homepage 2 Title',
    ...
    context "when homepage topic is updated" do
      ...
      setup do
        @topic = new_topic(@@cache_basket, true, { :title => 'Homepage 3 Title',
    ...
    context "when homepage topic is deleted" do
      ...
      setup do
        @topic = new_topic(@@cache_basket, true, { :title => 'Homepage 4 Title',
    ...
    context "when recent topics are enabled" do
      ...
      context "and when the basket has a topic added" do
        ...
        setup do
          @topic = new_topic(@@cache_basket, false, { :title => 'Recent Topic 1 Title',
      ...
      context "and when the basket has a topic updated" do
        ...
        setup do
          @topic = new_topic(@@cache_basket, false, { :title => 'Recent Topic 2 Title',
      ...
      context "and when the basket has a topic deleted" do
        ...
        setup do
          @topic = new_topic(@@cache_basket, false, { :title => 'Recent Topic 3 Title',
    ...
    context "when privacy controls are enabled" do
      ...
      context "and when homepage has a private version" do
        ...
        setup do
          @topic = new_topic(@@cache_basket, true, { :title => 'Public Title',
  ...
  context "The topic show cache" do
    ...
    context "when a topic is added" do
      ...
      setup do
        @topic = new_topic(@@cache_basket, false, { :title => 'Topic 1 Title',
    ...
    context "when a topic is updated" do
      ...
      setup do
        @topic = new_topic(@@cache_basket, false, { :title => 'Topic 2 Title',
    ...
    context "when a topic is deleted" do
      ...
      setup do
        @topic = new_topic(@@cache_basket, false, { :title => 'Topic 3 Title',
    ...
    context "when privacy controls are enabled" do
      ...
      context "and when topic has a private version" do
        ...
        setup do
          @topic = new_topic(@@cache_basket, false, { :title => 'Public Title',
                                                      :description => 'Public Description',
                                                      :private_false => true })
          check_cache_current_for(@topic, { :on_topic_already => true, :check_show_link => false })
          @topic = update_item(@topic, { :title => 'Private Title',
