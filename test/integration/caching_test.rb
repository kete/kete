...
class CachingTest < ActionController::IntegrationTest
  ...
  context "The homepage cache" do
    ...
    context "when homepage topic is added" do
      ...
      setup do
        @topic = new_homepage_topic({ :title => 'Homepage 1 Title',
                                      :description => 'Homepage 1 Description' }, @@cache_basket)
      end
    ...
    context "when homepage topic is replaced" do
      ...
      setup do
        @topic1 = new_homepage_topic({ :title => 'Old Homepage Topic Title',
                                       :description => 'Old Homepage Topic Description' }, @@cache_basket)
        check_cache_current_for(@topic1)
        @topic2 = new_homepage_topic({ :title => 'Homepage 2 Title',
                                       :description => 'Homepage 2 Description' }, @@cache_basket)
      end
    ...
    context "when homepage topic is updated" do
      ...
      setup do
        @topic = new_homepage_topic({ :title => 'Homepage 3 Title',
                                      :description => 'Homepage 3 Description' }, @@cache_basket)
        check_cache_current_for(@topic)
    ...
    context "when homepage topic is deleted" do
      ...
      setup do
        @topic = new_homepage_topic({ :title => 'Homepage 4 Title',
                                      :description => 'Homepage 4 Description' }, @@cache_basket)
        check_cache_current_for(@topic)
    ...
    context "when recent topics are enabled" do
      ...
      context "and when the basket has a topic added" do
        ...
        setup do
          @topic = new_topic({ :title => 'Recent Topic 1 Title',
                               :description => 'Recent Topic 1 Description' }, @@cache_basket)
        end
      ...
      context "and when the basket has a topic updated" do
        ...
        setup do
          @topic = new_topic({ :title => 'Recent Topic 2 Title',
                               :description => 'Recent Topic 2 Description' }, @@cache_basket)
          check_recent_topics_includes(@topic)
      ...
      context "and when the basket has a topic deleted" do
        ...
        setup do
          @topic = new_topic({ :title => 'Recent Topic 3 Title',
                               :description => 'Recent Topic 3 Description' }, @@cache_basket)
          check_recent_topics_includes(@topic)
          @topic = delete_item(@topic)
        end
    ...
    context "when privacy controls are enabled" do
      ...
      context "and when homepage has a private version" do
        ...
        setup do
          @topic = new_homepage_topic({ :title => 'Public Title',
  ...
  context "The topic show cache" do
    ...
    context "when a topic is updated" do
      ...
      setup do
        @topic = new_topic({ :title => 'Topic 2 Title',
                             :description => 'Topic 2 Description' }, @@cache_basket)
        check_cache_current_for(@topic, { :on_topic_already => true, :check_show_link => false })
