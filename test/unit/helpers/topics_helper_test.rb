...
class TopicsHelperTest < ActionView::TestCase
  ...
  context "The topic_types_counts_for" do
    ...
    should "correctly return a display of topic types and counts" do
      ...
      parent_topic = Factory(:topic, :title => 'Parent Topic', :topic_type_id => topic_types[0].id)
      child_topic_1 = Factory(:topic, :title => 'Child Topic 1', :topic_type_id => topic_types[1].id)
      child_topic_2 = Factory(:topic, :title => 'Child Topic 2', :topic_type_id => topic_types[2].id)
      ...
      data = "<ul>" +
               "<li>" +
                 "<a href=\"/en/site/all/topics/related_to/topic/#{parent_topic.to_param}?topic_type=person\" class=\"small\">" +
                   "#{topic_types[1].name.pluralize} (1)" +
                 "</a>" +
               "</li>" +
               "<li>" +
                 "<a href=\"/en/site/all/topics/related_to/topic/#{parent_topic.to_param}?topic_type=place\" class=\"small\">" +
