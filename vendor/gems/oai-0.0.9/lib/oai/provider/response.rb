...
module OAI
  ...
  class Base
    ...
    def valid?
      ...
      # Walter McGinnis, 2008-07-13
      # identify doesn't have any valid arguments
      # this was failing since valid_options was nil in that case
      return true if (@options.keys.nil? && self.class.valid_options.nil?)
      return true if (@options.keys.empty? && self.class.valid_options.empty?)
      return false if (self.class.valid_options.nil? && !@options.keys.nil?)
      return false if (self.class.valid_options.empty? && !@options.keys.empty?)
