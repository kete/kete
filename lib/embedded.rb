...
module Embedded
  unless included_modules.include? Embedded
    ...
    before_validation :harvest_embedded_metadata_to_attributes
    ...
    # THIS HANDLES SIMPLE CASE, for audio, video, documents where they don't have a separate model
    # of attachments
    def harvest_embedded_metadata_to_attributes
      ...
      # lastly we look at the mappings between
        ...
        standard_attribute_synonyms.each do |a_name, synonyms|
          ...
          if synonyms.include?(key)
            ...
            when 'tags'
              ...
              # will overwrite any preview value that has been assigned to the attribute
              # not append
